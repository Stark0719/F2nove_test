...
def on_press(key, client_socket):
    ...
    try:
        if key.char == 'w':  # Move Forward
            ...
            send_command(client_socket, "CMD_MOTOR#750#750#-750#-750\n")
...
def main():
    ...
    print("W - Move Forward (Speed: 1500)")
    print("S - Move Backward (Speed: -1500)")
    print("A - Turn Left (Speed: 750)")
    print("D - Turn Right (Speed: 750)")
    print("Q - Quit")
