        ...
        while running:
            for event in pygame.event.get():
                if event.type == pygame.JOYAXISMOTION:
                    ...
                    left_right = joystick.get_axis(2)  # Range: -1 to 1
                    ...
                    # Calculate motor speeds with enhanced turn power
                    forward_speed = int(forward_backward * -1500)  # Inverted for forward
                    turn_speed = int(left_right * 1500)  # Higher turn speed for better movement
                    ...
                    if forward_speed != 0 or turn_speed != 0:
                        ...
                        # Ensure motors have enough power for turning
